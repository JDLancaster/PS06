...
1. Instead of just evaluating for a point, coule we would evaluate over the whole interval by fitting a curve and then using its equation to calculate our score statistics? Something to do
